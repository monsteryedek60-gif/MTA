...
function showSettingsWindow(tab)
	...
	GUIEditor_Window.main = guiCreateWindow(x,y,w,h,"Ayarlar",false)
	...
	GUIEditor_Label.graphicSettingsgeneral = guiCreateLabel(0.0222,0.0361,0.313,lineH,"Genel Ayarlar:",true,GUIEditor_Tab.graphicSettings)
	guiSetFont(GUIEditor_Label.graphicSettingsgeneral,"default-bold-small")

	GUIEditor_Checkbox.graphic_motionblur = guiCreateCheckBox(0.036,0.1005,0.2992,lineH,"Motion Blur'u aktifleştir",false,true,GUIEditor_Tab.graphicSettings)
	...
	GUIEditor_Checkbox.graphic_skyclouds = guiCreateCheckBox(0.036,0.1005+posY,0.2992,lineH,"Gökyüzü Efektlerini aktifleştir",false,true,GUIEditor_Tab.graphicSettings)
	...
	GUIEditor_Checkbox.streams = guiCreateCheckBox(0.036,0.1005+posY,0.2992,lineH,"Sesleri aktifleştir",false,true,GUIEditor_Tab.graphicSettings)
	if getResourceFromName("vehicle_radio") then
	...
	if getResourceFromName("logs") then
	...
	if getResourceFromName("logs") and getResourceFromName("phone") then
	...
	GUIEditor_Checkbox.graphic_chatbub = guiCreateCheckBox(0.036,0.1005+posY,0.2992,lineH,"Sohbet balonlarını aktifleştir",false,true,GUIEditor_Tab.graphicSettings)
	if getResourceFromName("chat") then
	...
	GUIEditor_Checkbox.graphic_chatbub_square = guiCreateCheckBox(0.036,0.1005+posY,0.2992,lineH,"Sohbet balonlarını aktifleştir",false,true,GUIEditor_Tab.graphicSettings)
	if getResourceFromName("chat") and guiCheckBoxGetSelected(GUIEditor_Checkbox.graphic_chatbub) then
	...
	GUIEditor_Checkbox.graphic_typingicon = guiCreateCheckBox(0.036,0.1005+posY,0.2992,lineH,"Simgeleri aktifleştir",false,true,GUIEditor_Tab.graphicSettings)
	if getResourceFromName("chat") then
	...
	GUIEditor_Checkbox.graphic_nametags = guiCreateCheckBox(0.036,0.1005+posY,0.2992,lineH,"İsimleri aktifleştir",false,true,GUIEditor_Tab.graphicSettings)
	...
	GUIEditor_Checkbox.settings_hud_style = guiCreateCheckBox(0.036,0.1005+posY,0.2992,lineH,"Yeni HUD stilini aktifleştir",false,true,GUIEditor_Tab.graphicSettings)
	if getResourceFromName("hud") then
	...
	GUIEditor_Checkbox.graphic_shaderradar = guiCreateCheckBox(0.036,0.1005+posY,0.2992,lineH,"Radar Shaderini aktifleştir",false,true,GUIEditor_Tab.graphicSettings)
	...
	GUIEditor_Checkbox.graphic_shaderwater = guiCreateCheckBox(0.036,0.1005+posY,0.2992,lineH,"Su Shaderini aktifleştir",false,true,GUIEditor_Tab.graphicSettings)
	...
	GUIEditor_Checkbox.graphic_shaderveh = guiCreateCheckBox(0.036,0.1005+posY,0.2992,lineH,"Araç Shaderini aktifleştir",false,true,GUIEditor_Tab.graphicSettings)
	...
	GUIEditor_Checkbox.vehicle_hotkey = guiCreateCheckBox(0.036,0.1005+posY,0.2992,lineH,"Araç kısayol tuşlarını aktifleştir",false,true,GUIEditor_Tab.graphicSettings)
	...
	GUIEditor_Checkbox.autopark = guiCreateCheckBox(0.036,0.1005+posY,0.2992,lineH,"Otomatik park etmeyi aktifleştir",false,true,GUIEditor_Tab.graphicSettings)
	if getResourceFromName('vehicle') then
	...
	GUIEditor_Checkbox.vehicle_rims = guiCreateCheckBox(0.0222+posX,posY,0.313,lineH,"Özel jant modellerini aktifleştir",false,true,GUIEditor_Tab.graphicSettings)
	...
	posY = posY + lineH
	GUIEditor_Checkbox.phone_anim = guiCreateCheckBox(0.0222+posX,posY,0.313,lineH,"Telefon animasyonunu aktifleştir",false,true,GUIEditor_Tab.graphicSettings)
	...
	posY = posY + lineH
	GUIEditor_Checkbox.talk_anim = guiCreateCheckBox(0.0222+posX,posY,0.313,lineH,"Konuşma animasyonlarını aktifleştir",false,true,GUIEditor_Tab.graphicSettings)
	...
	posY = posY + lineH
	GUIEditor_Checkbox.pm_username = guiCreateCheckBox(0.0222+posX,posY,0.313,lineH,"PM'de kullanıcı isminizi gösterin.",false,true,GUIEditor_Tab.graphicSettings)
	...
	GUIEditor_Checkbox.dynamic_lighting = guiCreateCheckBox(0.0222+posX,posY,0.313,lineH,"Dinamik ışıklandırmayı aktifleştir.",false,true,GUIEditor_Tab.graphicSettings)
...
--[[
	...
	--outputDebugString("groundsnow="..tostring(groundsnow))
	if groundsnow then
		posY = posY + lineH
	...
	if xmas then
		posY = posY + lineH
		GUIEditor_Checkbox.xmastreefx = guiCreateCheckBox(0.0222+posX,posY,0.313,lineH,"Noel Ağacı efektini aktifleştir.",false,true,GUIEditor_Tab.graphicSettings)
	...
	posY = posY + lineH
	GUIEditor_Checkbox.punishment_notification_selector = guiCreateCheckBox(0.0222+posX,posY,0.313,lineH,"Admin cezalandırmalarını gizle.",false,true,GUIEditor_Tab.graphicSettings)
	...
	if exports.integration:isPlayerSupporter(getLocalPlayer()) or exports.integration:isPlayerTrialAdmin(getLocalPlayer()) then
		posY = posY + lineH
		GUIEditor_Checkbox.auto_check = guiCreateCheckBox(0.0222+posX,posY,0.313,lineH,"Otomatik /check yada /ar",false,true,GUIEditor_Tab.graphicSettings)
	...
	posY = posY + lineH
	GUIEditor_Checkbox.enableNewUIStyle = guiCreateCheckBox(0.0222+posX,posY,0.313,lineH,"Yeni GUI stilini aktifleştir",false,true,GUIEditor_Tab.graphicSettings)
	if getResourceFromName("hud") then
	...
	if exports.integration:isPlayerStaff(localPlayer) then
		posY = posY + lineH
		GUIEditor_Checkbox.enableIncomingReport = guiCreateCheckBox(0.0222+posX,posY,0.313,lineH,"Gelen rapor seslerini aktifleştir",false,true,GUIEditor_Tab.graphicSettings)
		...
		posY = posY + lineH
		GUIEditor_Checkbox.enableIncomingPriorityReport = guiCreateCheckBox(0.0222+posX,posY,0.313,lineH,"Öncelikli rapor seslerini aktifleştir",false,true,GUIEditor_Tab.graphicSettings)
	...
	posY = posY + lineH
	GUIEditor_Checkbox.misc_sounds = guiCreateCheckBox(0.0222+posX,posY,0.313,lineH,"Varsayılan sesleri devre dışı bırak",false,true,GUIEditor_Tab.graphicSettings)
	...
	posY = posY + lineH
	GUIEditor_Checkbox.snow_effect = guiCreateCheckBox(0.0222+posX,posY,0.313,lineH,"Kar modunu aktifleştir",false,true,GUIEditor_Tab.graphicSettings)
	if getElementData(localPlayer, "snow_effect") == true then
		guiCheckBoxSetSelected(GUIEditor_Checkbox.snow_effect,true)
	else
		guiCheckBoxSetSelected(GUIEditor_Checkbox.snow_effect,false)
	end
	...
	GUIEditor_Checkbox.enableOverlayDescriptionVeh = guiCreateCheckBox(0.036+posX,0.1005+lineH,0.2992,lineH,"Araç: Bilgilerini aktifleştir",false,true,GUIEditor_Tab.graphicSettings)
	if getResourceFromName("description") then
	...
	GUIEditor_Checkbox.enableOverlayDescriptionPro = guiCreateCheckBox(0.036+posX,0.1005+lineH*3,0.2992,lineH,"Mülk: Bilgilerini aktifleştir",false,true,GUIEditor_Tab.graphicSettings)
	if getResourceFromName("description") then
	...
	GUIEditor_Checkbox.enableOverlayDescriptionNote = guiCreateCheckBox(0.036+posX,0.1005+lineH*5,0.2992,lineH,"Not: Bilgilerini aktifleştir",false,true,GUIEditor_Tab.graphicSettings)
	if getResourceFromName("description") then
	...
	GUIEditor_Tab.Notifications = guiCreateTab("Bildirimler",GUIEditor_TabPanel.main)
	local lineH = 0.0515
	local posY = lineH

	GUIEditor_Label.graphicSettingsgeneral = guiCreateLabel(0.0222,0.0361,0.313,lineH,"Gelen bildirim ayarları:",true,GUIEditor_Tab.Notifications)
	guiSetFont(GUIEditor_Label.graphicSettingsgeneral,"default-bold-small")

	GUIEditor_Checkbox.noti_faction_updates = guiCreateCheckBox(0.036,0.1005,0.2992,lineH,"Birlik gelişmeleri",false,true,GUIEditor_Tab.Notifications)
	guiCheckBoxSetSelected(GUIEditor_Checkbox.noti_faction_updates,getElementData(localPlayer, "noti_faction_updates") ~= "0")

	GUIEditor_Checkbox.noti_offline_pm = guiCreateCheckBox(0.036,0.1005+posY,0.2992,lineH,"Gelen çevrimdışı mesjalar",false,true,GUIEditor_Tab.Notifications)
	guiCheckBoxSetSelected(GUIEditor_Checkbox.noti_offline_pm,getElementData(localPlayer, "noti_offline_pm") ~= "0")

	posY = posY + lineH
	GUIEditor_Checkbox.vehicle_inactivity_scanner = guiCreateCheckBox(0.036,0.1005+posY,0.2992,lineH,"Araç inaktifliği tarayıcısı",false,true,GUIEditor_Tab.Notifications)
	...
	posY = posY + lineH
	GUIEditor_Checkbox.interior_inactivity_scanner = guiCreateCheckBox(0.036,0.1005+posY,0.2992,lineH,"Mülk bildirimleri",false,true,GUIEditor_Tab.Notifications)
	...
	posY = posY + lineH
	GUIEditor_Checkbox.support_center = guiCreateCheckBox(0.036,0.1005+posY,0.2992,lineH,"Destek bölümü",false,true,GUIEditor_Tab.Notifications)
	guiCheckBoxSetSelected(GUIEditor_Checkbox.support_center,getElementData(localPlayer, "support_center") ~= "0")

	local lineW2 = 0.34
	local posX = lineW2
	posY = 0.1005
	GUIEditor_Label.graphicSettingsgeneral = guiCreateLabel(0.0222+posX,0.0361,0.313,lineH,"Genel Ayarlar:",true,GUIEditor_Tab.Notifications)
	guiSetFont(GUIEditor_Label.graphicSettingsgeneral,"default-bold-small")

	GUIEditor_Checkbox.noti_no_noti = guiCreateCheckBox(0.036+posX,0.1005,1,lineH,"Bildirim olmadığında butonu gösterme",false,true,GUIEditor_Tab.Notifications)
	guiCheckBoxSetSelected(GUIEditor_Checkbox.noti_no_noti,getElementData(localPlayer, "noti_no_noti") == "1")


	GUIEditor_Tab.Social = guiCreateTab("Sosyal",GUIEditor_TabPanel.main)
	local lineH = 0.0515
	local posY = lineH

	GUIEditor_Label.graphicSettingsgeneral = guiCreateLabel(0.0222,0.0361,0.313,lineH,"Arkadaşlar:",true,GUIEditor_Tab.Social)
	guiSetFont(GUIEditor_Label.graphicSettingsgeneral,"default-bold-small")

	GUIEditor_Checkbox.social_classic_user_interface = guiCreateCheckBox(0.036,0.1005,0.888,lineH,"Klasik oyuncu arayüzü",false,true,GUIEditor_Tab.Social)
	...
	GUIEditor_Checkbox.social_invite_only = guiCreateCheckBox(0.036,0.1005+posY,0.888,lineH,"Sadece istek yolla (Gelen tüm arkadaşlık isteklerini geri çevirir)",false,true,GUIEditor_Tab.Social)
	guiCheckBoxSetSelected(GUIEditor_Checkbox.social_invite_only,getElementData(localPlayer, "social_invite_only") == "1")

	posY = posY + lineH
	GUIEditor_Checkbox.social_friends_bypass_pmblock = guiCreateCheckBox(0.036,0.1005+posY,0.888,lineH,"Arkadaşlarımın PM engelimi geçmesine izin ver",false,true,GUIEditor_Tab.Social)
	...
	posY = posY + lineH
	GUIEditor_Checkbox.social_friend_updates = guiCreateCheckBox(0.036,0.1005+posY,0.888,lineH,"Arkadaş uyarısı ve bildirimlerini al",false,true,GUIEditor_Tab.Social)
	guiCheckBoxSetSelected(GUIEditor_Checkbox.social_friend_updates,getElementData(localPlayer, "social_friend_updates") ~= "0")

	posY = posY + lineH
	local indent = 0.02
	GUIEditor_Checkbox.social_friend_updates_on_off = guiCreateCheckBox(0.036+indent,0.1005+posY,0.888,lineH,"Çevrimiçi/Çevrimdışı durumu",false,true,GUIEditor_Tab.Social)
	...
	posY = posY + lineH
	GUIEditor_Checkbox.social_friend_updates_msg = guiCreateCheckBox(0.036+indent,0.1005+posY,0.888,lineH,"Durum Mesajları",false,true,GUIEditor_Tab.Social)
	...
	posY = posY + lineH
	GUIEditor_Checkbox.social_friend_updates_char = guiCreateCheckBox(0.036+indent,0.1005+posY,0.888,lineH,"Karakter değişikliği",false,true,GUIEditor_Tab.Social)
	...
	posY = posY + lineH
	GUIEditor_Checkbox.social_friend_updates_sound = guiCreateCheckBox(0.036+indent,0.1005+posY,0.888,lineH,"Ses efektlerini aktifleştir",false,true,GUIEditor_Tab.Social)
	...
	GUIEditor_Button.mainclose = guiCreateButton(0.0135,0.9135,0.9743,0.0675,"Kapat",true,GUIEditor_Window.main)
...
function options_updateGameSettings()
	...
	elseif source == GUIEditor_Checkbox.misc_sounds then
		...
		updateAccountSettings(name, value)
	elseif source == GUIEditor_Checkbox.snow_effect then
		triggerEvent( "switchGoundSnow", root, guiCheckBoxGetSelected( GUIEditor_Checkbox.snow_effect ) )
	end
end
